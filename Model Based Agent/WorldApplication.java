...
class WorldApplication {
    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            } else if (arg.equals("-p") == true) {

                printStuff = Boolean.parseBoolean(args[i + 1]);
                i++;
            }
        ...
        try {
            ...
            for (int currTrial = 0; currTrial < numTrials; currTrial++) {
                ...
                Simulation trial = new Simulation(wumpusEnvironment, maxSteps, outputWriter, nonDeterministicMode, printStuff);
